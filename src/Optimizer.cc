...
{    
    ...
    int nInitialCorrespondences_1 = nInitialCorrespondences; //JMX
    ...
    for(size_t it=0; it<4; it++)
    {
        ...
        nbad_array[it] = nBad; //JMX
        if(optimizer.edges().size()<10)
            break;
    }

    std::cout << "PPPPPose Optimization: " << nInitialCorrespondences_1 << "," << nbad_array[0] << "," << nbad_array[1] << "," << nbad_array[2] << "," << nbad_array[3] << std::endl;//JMX
